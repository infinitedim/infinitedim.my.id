...
function Navbar() {
  ...
  return (
    <nav className="container bg-custom-white-900 fixed mx-auto top-0 inset-x-0 max-w-5xl px-2 sm:px-6 lg:px-8 z-40">
      <div className="sm:container flex h-16 items-center justify-between bg-custozm-white-900">
