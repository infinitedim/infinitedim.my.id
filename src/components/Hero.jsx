        ...
        <Row>
          ...
          <Col lg='6' md='6'>
            <div className="hero__img">
              <img src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80" alt="" ></img>
            </div>
          </Col>
        </Row>
      </Container>
