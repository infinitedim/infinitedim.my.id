      ...
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-mood-gray rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d3966.117591762508!2d107.05738060000002!3d-6.248231899999989!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sid!4v1684254468298!5m2!1sen!2sid"
          />
        ...
        <div className="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          ...
          <Button className="text-white bg-mood-gray border-0 py-2 px-6 focus:outline-none hover:bg-custom-black-900 rounded text-lg">
            Sumbit here
          </Button>
